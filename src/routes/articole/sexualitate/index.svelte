<script context="module">
  export function preload({ params, query }) {
    return this.fetch(`articole/sexualitate.json`)
      .then(r => r.json())
      .then(posts => {
        return { posts };
      });
...
<div class="container">
  <div class="row">
    <div class="col-md-8 my-5 my-md-0">
      <div class="card">
        <h5 class="text-center p-3 my-0">Sexualitate</h5>
      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7 col-md-6 mb-md-0 mb-4 mt-xl-4 px-5">
                        <h5 class="font-weight-bold article-title">
                          <a
                            rel="prefetch"
                            href="articole/sexualitate/{post.slug}">
                            {post.title}
                          </a>
                        </h5>
                        <p class="article-text">
