...
<div class="container mt-5">
  ...
  <div class="p-5">
    ...
    <p class="paragraph-text">
      Shivani Center considera ca bunastarea psihologica a oamenilor este strans
      legata de modul in care evoluam ca societate. Noi ne dorim sa va oferim
      servicii de cea mai inalta calitate pentru a putea creste impreuna atat pe
      plan intrapersonal cat si in relatiile interumane.
    </p>
    <p class="paragraph-text">
    ...
    <blockquote>
      Nelson Mandela spunea ca „Educaţia este cea mai puternică armă pe care voi
      o puteţi folosi pentru a schimba lumea.” Cu totii ne dorim sa schimbam
      lumea, dar asta porneste de la fiecare dintre noi. Doar aici si acum putem
      actiona sa ne educam mintea spre a deveni cea mai buna varianta a noastra.
    </blockquote>
    <p class="paragraph-text">
      Orientarea noastra in psihoterapie experentiala urmeaza un proces
      terapeutic ce ofera sansa fiecaruia de a iesi singur la lumina, de a gasi
      solutii, de a se acepta pe sine, de a se ierta, de a se responsabiliza
      sa-si schimbe perspectiva asupra lucrurilor si asupra lui insusi. El
      experimenteaza bucuria de a evolua constient, de a-si descoperi singur
      conflictele interioare, vulnerabilitatile si blocajele ce l-au oprit pana
      acum sa fie in armonie cu propria persoana si cu ceilalti.
    </p>
    <p class="paragraph-text">
    ...
    <p class="paragraph-text">
      ...
      sanatatea in sens larg cuprinde toate cele trei planuri: psihic, fizic si
      spiritual. Neglijand una dinte ele, este afectat intregul echilibru
    ...
    <blockquote>
      Ne adresam tuturor oamenilor care isi doresc o schimbare in stilul lor de
      viata, o imbunatatire a sanatatii si a interactiunii cu cei din jur si mai
      ales celor care simt ca nu mai pot face fata problemelor zilnice, se
      confrunta cu stari de stres, anxietate, depresie, vinovatie, frustrare,
      sentimente de neputinta, probleme in relatia de cuplu, de familie, etc.
    </blockquote>
    <p class="paragraph-text">
